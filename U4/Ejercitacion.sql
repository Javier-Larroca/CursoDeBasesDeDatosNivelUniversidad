...
GO
CREATE TABLE [Articulos.Marcas] (
	IdArticulo int not null,
	IdMarca int not null,

    CONSTRAINT PK_ArticulosMarcas PRIMARY KEY (IdArticulo, IdMarca),
    CONSTRAINT FK_ArticulosMarcas_Articulo FOREIGN KEY (IdArticulo) REFERENCES Articulos (Id),
    CONSTRAINT FK_ArticulosMarcas_Marca FOREIGN KEY (IdMarca) REFERENCES Marcas (Id)
)
